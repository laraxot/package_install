...
class zeroInstall
{
    ...
    public function step3()
    {
        ...
        echo '<h3>pos: '.$pos.'</h3>';
        $index_content_before = \mb_substr($index_content, 0, $pos);
        $index_content_after = \mb_substr($index_content, $pos);
...
';
    ...
    public function step9()
    {
        ...
        $pos = \mb_strrpos($content, $str);
        echo '<h3>pos: '.$pos.'</h3>';
        $pos += \mb_strlen($str);
        $content_before = \mb_substr($content, 0, $pos);
        $content_after = \mb_substr($content, $pos);
        $add_content = "
		//--- XRA 
